...
describe AttachmentsController do
  ...
  let(:valid_attributes) { { "position_request_id" => "1" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved attachment as @attachment" do
        ...
        post :create, {:attachment => { "position_request_id" => "invalid value" }}, valid_session
        assigns(:attachment).should be_a_new(Attachment)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested attachment" do
        ...
        Attachment.any_instance.should_receive(:update).with({ "position_request_id" => "1" })
        put :update, {:id => attachment.to_param, :attachment => { "position_request_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the attachment as @attachment" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Attachment.any_instance.stub(:save).and_return(false)
        put :update, {:id => attachment.to_param, :attachment => { "position_request_id" => "invalid value" }}, valid_session
        assigns(:attachment).should eq(attachment)
      end
