...
describe "position_requests/edit" do
  before(:each) do
  ...
  it "renders the edit position_request form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", position_request_path(@position_request), "post" do
